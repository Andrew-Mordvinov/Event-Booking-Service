...
public static class StorageErrors
{
    ...
    public static string PageMustBePositive = "Страница не может быть меньше 1";
    public static string PageSizeMustBePositive = "Размер страницы не может быть меньше 1";
